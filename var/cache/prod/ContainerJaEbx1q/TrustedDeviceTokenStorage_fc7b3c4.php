...
class TrustedDeviceTokenStorage_fc7b3c4 extends \Scheb\TwoFactorBundle\Security\TwoFactor\Trusted\TrustedDeviceTokenStorage implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    {
        $this->initializer3b229 && ($this->initializer3b229->__invoke($valueHolder526a8, $this, 'hasUpdatedCookie', array(), $this->initializer3b229) || 1) && $this->valueHolder526a8 = $valueHolder526a8;
        return $this->valueHolder526a8->hasUpdatedCookie();
    }
    public function getCookieValue() : ?string
    {
        $this->initializer3b229 && ($this->initializer3b229->__invoke($valueHolder526a8, $this, 'getCookieValue', array(), $this->initializer3b229) || 1) && $this->valueHolder526a8 = $valueHolder526a8;
        return $this->valueHolder526a8->getCookieValue();
    }
    public function hasTrustedToken(string $username, string $firewall, int $version) : bool
    {
        $this->initializer3b229 && ($this->initializer3b229->__invoke($valueHolder526a8, $this, 'hasTrustedToken', array('username' => $username, 'firewall' => $firewall, 'version' => $version), $this->initializer3b229) || 1) && $this->valueHolder526a8 = $valueHolder526a8;
        return $this->valueHolder526a8->hasTrustedToken($username, $firewall, $version);
    }
    public function addTrustedToken(string $username, string $firewall, int $version) : void
    {
        $this->initializer3b229 && ($this->initializer3b229->__invoke($valueHolder526a8, $this, 'addTrustedToken', array('username' => $username, 'firewall' => $firewall, 'version' => $version), $this->initializer3b229) || 1) && $this->valueHolder526a8 = $valueHolder526a8;
        $this->valueHolder526a8->addTrustedToken($username, $firewall, $version);
return;
    }
    ...
    public function __construct(\Symfony\Component\HttpFoundation\RequestStack $requestStack, \Scheb\TwoFactorBundle\Security\TwoFactor\Trusted\JwtTokenEncoder $jwtTokenEncoder, string $cookieName, int $trustedTokenLifetime)
    {
        ...
        $this->valueHolder526a8->__construct($requestStack, $jwtTokenEncoder, $cookieName, $trustedTokenLifetime);
    }
